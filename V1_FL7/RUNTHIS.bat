@echo off
mode 160,50
title SoulTaker MultiTool ~ Edited By @Dannyg82
:menu
type menu.py
color b
...
if '%action%'=='28' goto sfinder
if '%action%'=='29' goto leak
if '%action%'=='30' goto agen
...
:sfinder
@echo off & cls
start %cd%\PROGRAMS\Social_Finder.bat
goto menu

:leak
@echo off & cls
explorer "https://leak.sx/dispenser.php"
goto menu

:agen
@echo off & cls
explorer "https://www.a-gen.xyz"
goto menu

:exit
@echo off & cls
start %cd%\PROGRAMS\FLVFX_LOOKUP.bat
goto menu
